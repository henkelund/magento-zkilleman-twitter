...
/**
 * Zkilleman_Twitter_Model_Mysql4_Tweet
 *
 * @category   Zkilleman
 * @package    Zkilleman_Twitter
 * @author     Henrik Hedelund <henke.hedelund@gmail.com>
 */
class Zkilleman_Twitter_Model_Mysql4_Tweet extends Mage_Core_Model_Mysql4_Abstract
{
    protected function _construct()
    {
        $this->_init('twitter/tweet', 'tweet_id');
    }
}